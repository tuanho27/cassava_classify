...
from timm.models.layers import SelectiveKernelConv, ConvBnAct, create_attn, AntiAliasDownsampleLayer
...
class SelectiveKernelBottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,
                 ...
                 attn_layer="cbam", 
                 aa_layer=AntiAliasDownsampleLayer,
                 drop_block=0.2, 
                 drop_path=0.2):
...
def skresnet50d(pretrained=False, **kwargs):
    ...
    model_args = dict(
        ...
        block_args=dict(sk_kwargs=sk_kwargs), zero_init_last_bn=True, **kwargs)
...
def skresnext50_32x4d(pretrained=False, **kwargs):
    ...
    model = _create_skresnet('skresnext50_32x4d', pretrained, **model_args)
    in_ch = model.fc.in_features
    new_fc = nn.Linear(in_ch, 5)
    model.fc = new_fc
    return model
